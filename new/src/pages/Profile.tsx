...
const Profile: React.FC = () => {
  ...
  const { currentUser, userProfile, logout, updateUserProfile, changePassword } = useAuth()
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-3" style={{ gap: '2rem' }}>
          ...
          <div style={{ gridColumn: 'span 2' }}>
            ...
            {showChangePassword && (
              <div className="card" style={{ marginTop: '2rem' }}>
                <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1rem' }}>Change Password</h2>
