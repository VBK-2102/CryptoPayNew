...
const Navbar: React.FC = () => {
  ...
  const [authType, setAuthType] = useState<'login' | 'signup' | 'forgot-password'>('login')
  ...
  const isAdminWalletConnected =
    ...
    isConnected &&
    account !== null &&
    ADMIN_WALLET_ADDRESSES.some(addr => addr.toLowerCase() === account.toLowerCase())
  ...
  const handleAuthModal = (type: 'login' | 'signup' | 'forgot-password') => {
    setAuthType(type)
