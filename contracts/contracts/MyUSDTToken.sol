...
/**
 * @title MyUSDTToken
 * @dev Your custom USDT Token - A custom ERC20 token for your CryptoWallet platform
 * @dev Owner: 0xDA2D9bAf72B034cF466fDd5bB2F3cb24164a62FC
 */
contract MyUSDTToken is ERC20, Ownable {
    
    constructor() ERC20("My USDT Token", "USDT") {
        // Mint initial supply to contract deployer (your admin address)
        _mint(msg.sender, 1000000 * 10**decimals()); // 1 million USDT tokens
    }
